...
Amph=c("ATw","ATl","ARp","ARf","ATe","S","Se", "Tda")
ATl=c("ATl")
ATe=c("ATe")
ARf=c("ARf")
ARp=c("ARp")
...
colnames(HT_WL_metrics)<-c("Wet_Natives", "Wet_Exotics", "Terr_Natives", "Terr_Exotics","WetNatRich", "WetExoticRich","TerrNatRich", "TerrExoticRich" , "Wet_diversity", "Dry_diversity",
