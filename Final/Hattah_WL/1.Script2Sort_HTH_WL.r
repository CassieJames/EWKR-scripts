...
write.csv(Output , file = "Spp_site_year_transect matrix HTH_WL_July 2018.csv") # save data out
...
write.csv(tada , file = "Data summary table HTH_WL_July 2018.csv") # save data out
...
data.dir = "C:/Users/jc246980/Documents/MD Vegetation/Hattah_data_csvs/"; setwd (data.dir)
write.csv(tada , file = "Spp_site_year matrix HTH_WL_July 2018.csv") # save data out
...
data.dir = "C:/Users/jc246980/Documents/MD Vegetation/Hattah_data_csvs/"; setwd (data.dir) 
write.csv(tada2 , file = "Spp_site matrix HTH_WL_July 2018.csv") # save data out
