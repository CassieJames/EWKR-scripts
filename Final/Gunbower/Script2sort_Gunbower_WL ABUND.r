...
write.csv(Output , file = "Spp_site_transect_year_season matrix Gunbower_WL_May 2019.csv") # save data out
...
data.dir = "C:/Users/jc246980/Documents/Current projects/MD Vegetation/Gunbower_data_csvs/"; setwd (data.dir) 
write.csv(tada , file = "Spp_site_matrix Gunbower_WL_May 2019.csv") # save data out
...
data.dir = "C:/Users/jc246980/Documents/Current projects/MD Vegetation/Gunbower_data_csvs/"; setwd (data.dir) 
write.csv(tada , file = "Spp_site_year matrix Gunbower_WL_May 2019.csv") # save data out
...
data.dir = "C:/Users/jc246980/Documents/Current projects/MD Vegetation/Gunbower_data_csvs/"; setwd (data.dir) 
write.csv(tada , file = "Spp_site_year_season matrix Gunbower_WL_May 2019.csv") # save data out
...
rownames(tada)=paste("GUN","_",rownames(tada),sep="")

tada[tada<3 ] <- 0 # if species recorded less than 3 times turn value to zero

data.dir = "C:/Users/jc246980/Documents/Current projects/MD Vegetation/Gunbower_data_csvs/"; setwd (data.dir) 
write.csv(tada , file = "Spp_site_matrix Gunbower_WL_May 2019 COMMON ONLY.csv") # save data out
################################################################################################################################
...
data.dir = "C:/Users/jc246980/Documents/Current projects/MD Vegetation/Gunbower_data_csvs/"; setwd (data.dir)
write.csv(tada , file = "Data summary table Gunbower_WL_May 2019 ABUND.csv") # save data out