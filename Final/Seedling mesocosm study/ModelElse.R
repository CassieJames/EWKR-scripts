...
anova(lArea.lme2, lArea.lme5) #L=98.13
...
anova(Height.lme4, Height.lme5) # L=56.73
...
anova(RootLength.lme4, RootLength.lme5) # L=58.09
...
anova(MassAbove.lme4, MassAbove.lme5)#L = 61.15
...
anova(MassBelow.lme4, MassBelow.lme5) #L=49.84
