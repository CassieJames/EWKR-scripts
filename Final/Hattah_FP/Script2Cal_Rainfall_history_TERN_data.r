...
map<-ggmap(get_map(map_center, zoom = 11, source = 'osm', maptype = 'terrain'), darken = c(0.3, 'black'), extent = 'device') +
  geom_point(data = DatesLL, aes(lon, lat), colour = 'red', size = 2)
...
YEARS=c("2008","2009", "2010", "2011", "2012") # data only goes to 2012 but will poss be updated soon to 2014
