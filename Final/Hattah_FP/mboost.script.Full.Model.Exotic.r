...
envdata=data.matrix[,c("d30", "d90", "d180", "d365", "Inundated","Flood_frequency","TSLF", "Easting", "Northing","exotic_prop", "Site.ID")]
...
envdata$exotic.pa=envdata$exotic
envdata$exotic.pa[envdata$exotic.pa>0] <- 1
envdata$exotic.pa=as.factor(envdata$exotic.pa) # this model just seems awful and i am not sure why
