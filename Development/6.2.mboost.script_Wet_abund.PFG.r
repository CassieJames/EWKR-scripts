...
envdata$d3Mon_cv=as.numeric(scale((envdata$d3Mon_cv),center=TRUE, scale=FALSE))
envdata$d3Mon_cvmonthall=as.numeric(scale((envdata$d3Mon_cvmonthall),center=TRUE, scale=FALSE))
envdata$d3Mon_drylength=as.numeric(scale((envdata$d3Mon_drylength),center=TRUE, scale=FALSE))
envdata$d1yrs_cv=as.numeric(scale((envdata$d1yrs_cv),center=TRUE, scale=FALSE))
envdata$d1yrs_cvmonthall=as.numeric(scale((envdata$d1yrs_cvmonthall),center=TRUE, scale=FALSE))
envdata$d1yrs_drylength=as.numeric(scale((envdata$d1yrs_drylength),center=TRUE, scale=FALSE))
envdata$d3yrs_cv=as.numeric(scale((envdata$d3yrs_cv),center=TRUE, scale=FALSE))
envdata$d3yrs_cvmonthall=as.numeric(scale((envdata$d3yrs_cvmonthall),center=TRUE, scale=FALSE))
